...
import CardWelcome from "./FormCard/CardWelcome/CardWelcome";
import FormUpload from "./FormCard/FormUpload/FormUpload";
import IconoUpload from "@/assets/Icon/IconoUpload";
import FormOwnerInfo from "./FormCard/FormOwnerInfo/FormOwnerInfo";

const MultiStepFormCompany = () => {
  ...
  const [circle, setCircle] = useState([
    ...
    },
    {
      id: 3,
      label: "Files Upload",
      description: "Submit some relevant documents",
      icon: <IconoUpload />,
    },
    {
      id: 4,
    ...
    },
    {
      id: 5,
      label: "Set Password",
      description: "Uphold minimun security criteria",
  ...
  return (
    <div className="mx-auto w-full h-screen flex flex-col justify-center items-center  px-4  sm:px-6 lg:px-8 bg-[--background-dark-blue] overflow-hidden relative ">
      <Header />
      ...
      <div className="flex flex-col w-[90%] h-[510px] 2xl:h-[590px] 2xl:max-w-screen-xl justify-between rounded-[32px]  bg-[--background-soft-blue] items-center mt-14 scale-90">
        ...
        <div className="lg:flex md:flex-grow gap-12 w-full h-full justify-center items-center lg:py-5 lg:px-5 2xl:py-10 2xl:px-10">
          <StepsCard
            circle={circle}
...
export default MultiStepFormCompany;
